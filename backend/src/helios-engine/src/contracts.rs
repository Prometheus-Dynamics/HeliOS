...
pub mod stream_ids {
    pub use super::generated_runtime_contracts::stream_ids::{CALIBRATION_MODE_PIPELINE_UUID, RAW_PIPELINE_UUID};
}
...
mod tests {
    ...
    use super::stream_ids::{CALIBRATION_MODE_PIPELINE_UUID, RAW_PIPELINE_UUID};
