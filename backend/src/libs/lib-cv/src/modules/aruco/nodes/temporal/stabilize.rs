...
pub(super) struct ArucoTemporalStabilizeDetectionsConfig {
    ...
    pub(super) carry_passthrough_frames: i64,
    ...
    #[port(default = true)]
    pub(super) carry_require_quad_support: bool,
    ...
    pub(super) carry_quad_max_area_ratio: f64,
    ...
    pub(super) carry_quad_max_corner_shift_ratio: f64,
    ...
    pub(super) corner_smooth_alpha: f64,
    #[port(default = 0.8f64, meta(ui_min = 0.05, ui_max = 2.0, ui_step = 0.01))]
    pub(super) corner_smooth_max_corner_shift_ratio: f64,
    #[port(default = 40.0f64, meta(ui_min = 0.0, ui_max = 256.0, ui_step = 1.0))]
    pub(super) corner_smooth_max_center_shift_px: f64,
    #[port(default = 2.0f64, meta(ui_min = 1.0, ui_max = 10.0, ui_step = 0.1))]
    pub(super) corner_smooth_max_area_ratio: f64,
    #[port(default = true)]
    pub(super) corner_smooth_only_age1: bool,
}
...
pub(super) fn cv_aruco_temporal_stabilize_detections(
    frame: &DynamicImage,
