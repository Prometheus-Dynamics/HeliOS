...
pub(crate) fn overlay_count_label(image: &mut DynamicImage, label: &str, count: usize) {
    const HUD_W: u32 = 240;
    const HUD_H: u32 = 72;
    const PAD_X: u32 = 8;
    const PAD_Y: u32 = 8;
...
pub(crate) fn overlay_tags_count(image: &mut DynamicImage, count: usize) {
...
pub(crate) fn overlay_id_label_centered(image: &mut DynamicImage, id: u32, center_x: i64, y: i64) {
...
pub(crate) fn overlay_detection_crosshair(image: &mut DynamicImage, cx: i64, cy: i64, size_px: i64, thickness: u32, color: Rgba<u8>) {
...
pub(crate) struct ArucoOverlayDetectionsConfig {
