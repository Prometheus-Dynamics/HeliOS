use super::{EngineConnection, ExpectedEvent, StartRecordingParams, engine_ipc_policy};
...
use lib_runtime_policy::{
    HELIOS_ENGINE_CAPTURE_SHADOW_TIMEOUT, HELIOS_ENGINE_PIPELINE_LAYOUT_TIMEOUT, HELIOS_ENGINE_RESPONSE_TIMEOUT, HELIOS_ENGINE_START_STREAM_TIMEOUT, HELIOS_ENGINE_STOP_RECORDING_TIMEOUT,
    HELIOS_ENGINE_STOP_STREAM_TIMEOUT,
};
...
impl EngineConnection {
    pub async fn start_stream(&self, manifest: ResolvedStreamConfig) -> Result<EngineEvent, lib_ipc::client::ClientTransportError> {
        self.request(|command_id| EngineCommand::Start { command_id, manifest: Box::new(manifest) }, ExpectedEvent::Start, "start_stream", HELIOS_ENGINE_START_STREAM_TIMEOUT).await
    }

    pub async fn stop_stream(&self, id: uuid::Uuid) -> Result<EngineEvent, lib_ipc::client::ClientTransportError> {
        self.stop_stream_with_timeout(id, HELIOS_ENGINE_STOP_STREAM_TIMEOUT).await
    }
    ...
    pub async fn get_controls(&self, id: uuid::Uuid) -> Result<EngineEvent, lib_ipc::client::ClientTransportError> {
        self.request(|command_id| EngineCommand::GetControls { command_id, stream_id: id }, ExpectedEvent::Controls { stream_id: id }, "get_controls", HELIOS_ENGINE_RESPONSE_TIMEOUT).await
    }

    pub async fn get_metrics(&self, id: uuid::Uuid) -> Result<EngineEvent, lib_ipc::client::ClientTransportError> {
        self.request(|command_id| EngineCommand::GetMetrics { command_id, stream_id: id }, ExpectedEvent::Metrics { stream_id: id }, "get_metrics", HELIOS_ENGINE_RESPONSE_TIMEOUT).await
    }
    ...
    pub async fn snapshot_jpeg(&self, id: uuid::Uuid, quality: u8, source: Option<helios_engine::ipc::RecordingSource>) -> Result<Vec<u8>, lib_ipc::client::ClientTransportError> {
        match self
            .request(
                |command_id| EngineCommand::SnapshotJpeg { command_id, stream_id: id, quality, source },
                ExpectedEvent::SnapshotJpeg { stream_id: id },
                "snapshot_jpeg",
                HELIOS_ENGINE_RESPONSE_TIMEOUT,
            )
            .await?
        {
    ...
    pub async fn stop_recording(&self, id: uuid::Uuid) -> Result<EngineEvent, lib_ipc::client::ClientTransportError> {
        self.request(|command_id| EngineCommand::StopRecording { command_id, stream_id: id }, ExpectedEvent::Ack, "stop_recording", HELIOS_ENGINE_STOP_RECORDING_TIMEOUT).await
    }
    ...
    pub async fn capture_shadow_recording(
        ...
        self.request(
            ...
            HELIOS_ENGINE_CAPTURE_SHADOW_TIMEOUT,
        )
        .await
    }

    pub async fn get_node_registry(&self) -> Result<NodeRegistrySnapshot, lib_ipc::client::ClientTransportError> {
        self.get_node_registry_with_timeout(HELIOS_ENGINE_RESPONSE_TIMEOUT).await
    }
    ...
    pub async fn discover_devices(&self) -> Result<helios_engine::capture::DiscoveryResult, lib_ipc::client::ClientTransportError> {
        match self.request(|command_id| EngineCommand::DiscoverDevices { command_id }, ExpectedEvent::Discovery, "discover_devices", HELIOS_ENGINE_RESPONSE_TIMEOUT).await? {
    ...
    pub async fn set_graph(&self, id: uuid::Uuid, graph: serde_json::Value, pipeline_id: Option<uuid::Uuid>, output: Option<String>) -> Result<EngineEvent, lib_ipc::client::ClientTransportError> {
        self.request(|command_id| EngineCommand::SetGraph { command_id, stream_id: id, graph: graph.into(), pipeline_id, output }, ExpectedEvent::Ack, "set_graph", HELIOS_ENGINE_RESPONSE_TIMEOUT)
            .await
    }
    ...
    pub async fn set_graph_patch(&self, id: uuid::Uuid, patch: serde_json::Value, pipeline_id: Option<uuid::Uuid>) -> Result<EngineEvent, lib_ipc::client::ClientTransportError> {
        self.request(|command_id| EngineCommand::SetGraphPatch { command_id, stream_id: id, patch: patch.into(), pipeline_id }, ExpectedEvent::Ack, "set_graph_patch", HELIOS_ENGINE_RESPONSE_TIMEOUT)
            .await
    }
    ...
    pub async fn set_control(&self, id: uuid::Uuid, control_id: u32, value: helios_engine::capture::CaptureControlValue) -> Result<EngineEvent, lib_ipc::client::ClientTransportError> {
        self.request(|command_id| EngineCommand::SetControl { command_id, stream_id: id, control_id, value }, ExpectedEvent::Ack, "set_control", HELIOS_ENGINE_RESPONSE_TIMEOUT).await
    }
    ...
    pub async fn set_graph_output(&self, id: uuid::Uuid, output: Option<String>) -> Result<EngineEvent, lib_ipc::client::ClientTransportError> {
        self.request(|command_id| EngineCommand::SetGraphOutput { command_id, stream_id: id, output }, ExpectedEvent::Ack, "set_graph_output", HELIOS_ENGINE_RESPONSE_TIMEOUT).await
    }
    ...
    pub async fn set_pipeline_inputs(
        ...
        self.request(
            |command_id| EngineCommand::SetPipelineInputs { command_id, stream_id: id, pipeline_id, inputs: mapped },
            ExpectedEvent::Ack,
            "set_pipeline_inputs",
            HELIOS_ENGINE_RESPONSE_TIMEOUT,
        )
    ...
    pub async fn set_pipeline_layout(&self, id: uuid::Uuid, layout: Option<helios_engine::ipc::StreamPipelineLayout>) -> Result<EngineEvent, lib_ipc::client::ClientTransportError> {
        self.request(|command_id| EngineCommand::SetPipelineLayout { command_id, stream_id: id, layout }, ExpectedEvent::Ack, "set_pipeline_layout", HELIOS_ENGINE_PIPELINE_LAYOUT_TIMEOUT).await
    }
    ...
    pub async fn set_pipeline_wires(&self, id: uuid::Uuid, wires: Vec<helios_engine::ipc::StreamPipelineWire>) -> Result<EngineEvent, lib_ipc::client::ClientTransportError> {
        self.request(|command_id| EngineCommand::SetPipelineWires { command_id, stream_id: id, wires }, ExpectedEvent::Ack, "set_pipeline_wires", HELIOS_ENGINE_PIPELINE_LAYOUT_TIMEOUT).await
    }
    ...
    pub async fn set_graph_perf(&self, id: uuid::Uuid, pipeline_id: Option<uuid::Uuid>, enabled: bool) -> Result<EngineEvent, lib_ipc::client::ClientTransportError> {
        self.request(|command_id| EngineCommand::SetGraphPerf { command_id, stream_id: id, pipeline_id, enabled }, ExpectedEvent::Ack, "set_graph_perf", HELIOS_ENGINE_RESPONSE_TIMEOUT).await
    }
    ...
    pub async fn reset_graph_metrics(&self, id: uuid::Uuid, pipeline_id: Option<uuid::Uuid>) -> Result<EngineEvent, lib_ipc::client::ClientTransportError> {
        self.request(|command_id| EngineCommand::ResetGraphMetrics { command_id, stream_id: id, pipeline_id }, ExpectedEvent::Ack, "reset_graph_metrics", HELIOS_ENGINE_RESPONSE_TIMEOUT).await
    }
    ...
    pub async fn list_graph_outputs_event(&self, id: uuid::Uuid) -> Result<EngineEvent, lib_ipc::client::ClientTransportError> {
        self.request(|command_id| EngineCommand::ListGraphOutputs { command_id, stream_id: id }, ExpectedEvent::GraphOutputs { stream_id: id }, "list_graph_outputs", HELIOS_ENGINE_RESPONSE_TIMEOUT)
            .await
    }
    ...
    pub async fn set_codecs(&self, id: uuid::Uuid, decoder_id: Option<String>, encoder_id: Option<String>) -> Result<EngineEvent, lib_ipc::client::ClientTransportError> {
        self.request(|command_id| EngineCommand::SetCodecs { command_id, stream_id: id, decoder_id, encoder_id }, ExpectedEvent::Ack, "set_codecs", HELIOS_ENGINE_RESPONSE_TIMEOUT).await
    }
    ...
    pub async fn set_calibration(&self, id: uuid::Uuid, calibration: Option<StreamCalibration>) -> Result<EngineEvent, lib_ipc::client::ClientTransportError> {
        self.request(|command_id| EngineCommand::SetCalibration { command_id, stream_id: id, calibration }, ExpectedEvent::Ack, "set_calibration", HELIOS_ENGINE_RESPONSE_TIMEOUT).await
    }
    ...
    pub async fn set_calibration_mode(&self, id: uuid::Uuid, enabled: bool, dictionary: Option<String>, mode: Option<String>) -> Result<EngineEvent, lib_ipc::client::ClientTransportError> {
        self.request(
            |command_id| EngineCommand::SetCalibrationMode { command_id, stream_id: id, enabled, dictionary, mode },
            ExpectedEvent::Ack,
    ...
    pub async fn solve_calibration_event(&self, request: CalibrationSolveRequest) -> Result<EngineEvent, lib_ipc::client::ClientTransportError> {
        self.request(|command_id| EngineCommand::SolveCalibration { command_id, request }, ExpectedEvent::CalibrationSolved, "solve_calibration", engine_ipc_policy().calibration_solve_timeout).await
    }
    ...
    pub async fn solve_localization_event(&self, request: LocalizationSolveRequest) -> Result<EngineEvent, lib_ipc::client::ClientTransportError> {
        ...
        self.request(|command_id| EngineCommand::SolveLocalization { command_id, request }, ExpectedEvent::LocalizationSolved, "solve_localization", engine_ipc_policy().localization_solve_timeout)
            .await
    }
    ...
    pub async fn list_streams(&self) -> Result<Vec<helios_engine::ipc::StreamSummary>, lib_ipc::client::ClientTransportError> {
        self.list_streams_with_timeout(HELIOS_ENGINE_RESPONSE_TIMEOUT).await
    }
