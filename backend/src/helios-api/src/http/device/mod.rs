...
pub fn router() -> Router<AppState> {
    Router::new()
        ...
        .route("/snapshots", get(snapshots::list_device_snapshots).post(snapshots::capture_device_snapshot))
        .route("/snapshots/{id}", axum::routing::delete(snapshots::delete_device_snapshot))
        .route("/snapshots/{id}/download", get(snapshots::download_device_snapshot))
