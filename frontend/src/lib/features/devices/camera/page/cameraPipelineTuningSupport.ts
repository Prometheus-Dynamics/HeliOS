...
export type PipelineTuningDragState = {
  startX: number;
  startY: number;
  originX: number;
  originY: number;
...
export type PipelineTuningResizeState = {
  startX: number;
  startY: number;
  originW: number;
  originH: number;
...
export type PipelineTuningPosition = {
  x: number;
  y: number;
};

export type PipelineTuningSize = {
  width: number;
  height: number;
};

export type StreamUpdatesSocket = {
