...
type LayoutPipelineState = {
  pipelineOutputByPipelineId: LayoutControllerState['pipelineOutputByPipelineId'];
  pipelineGraphLoading: LayoutControllerState['pipelineGraphLoading'];
  pipelineGraphError: LayoutControllerState['pipelineGraphError'];
  pipelineGraphs: LayoutControllerState['pipelineGraphs'];
  pipelineOutputOptions: LayoutControllerState['pipelineOutputOptions'];
  selectedPipelineOutput: LayoutControllerState['selectedPipelineOutput'];
  selectedPipelineGraph: LayoutControllerState['selectedPipelineGraph'];
  pipelineLayoutApplyTimer: LayoutControllerState['pipelineLayoutApplyTimer'];
  pipelineLayoutTouched: LayoutControllerState['pipelineLayoutTouched'];
  pipelineAssignmentsTouched: LayoutControllerState['pipelineAssignmentsTouched'];
  pipelineGridRows: LayoutControllerState['pipelineGridRows'];
  pipelineGridColumns: LayoutControllerState['pipelineGridColumns'];
  pipelineGridSlots: LayoutControllerState['pipelineGridSlots'];
  pipelineGridSlotOutputKeys: LayoutControllerState['pipelineGridSlotOutputKeys'];
  assignedPipelineIds: LayoutControllerState['assignedPipelineIds'];
  pipelineAssignDraft: LayoutControllerState['pipelineAssignDraft'];
  pipelineAssignQuery: LayoutControllerState['pipelineAssignQuery'];
  pipelineAssignModalOpen: LayoutControllerState['pipelineAssignModalOpen'];
  pipelineRemoveModalOpen: LayoutControllerState['pipelineRemoveModalOpen'];
  pipelineRemoveCandidateId: LayoutControllerState['pipelineRemoveCandidateId'];
  pipelineDragPayload: LayoutControllerState['pipelineDragPayload'];
  selectedPipelineId: LayoutControllerState['selectedPipelineId'];
  pipelineUiHydrated: LayoutControllerState['pipelineUiHydrated'];
};

type LayoutRuntimeArgs = {
  streamId: string;
  stream: () => LayoutControllerState['stream'];
  manifestState: () => LayoutControllerState['manifestState'];
  pipelineState: LayoutPipelineState;
  pipelineRegistrySnapshot: () => LayoutControllerState['pipelineRegistrySnapshot'];
  setPipelineRegistrySnapshot: (value: LayoutControllerState['pipelineRegistrySnapshot']) => void;
  pipelineGraphCache: () => LayoutControllerState['pipelineGraphCache'];
  setPipelineGraphCache: (value: LayoutControllerState['pipelineGraphCache']) => void;
  pipelineOutputOptionsCache: () => LayoutControllerState['pipelineOutputOptionsCache'];
  setPipelineOutputOptionsCache: (value: LayoutControllerState['pipelineOutputOptionsCache']) => void;
  refresh: () => Promise<void>;
  scheduleStreamPresetApply: () => void;
  onExternalLayoutApplied?: () => void;
  applyPipelineOverridesToGraph: LayoutControllerDeps['applyPipelineOverridesToGraph'];
